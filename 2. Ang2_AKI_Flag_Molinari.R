library(tidyverse)
library(readxl)
source("/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/Ang2/Code/0. Ang2_Functions.R")

data = read_xlsx("/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/Ang2/Data/VMI/SepsisAKI_Molinari_02112021.xlsx")
names(data)
...
# Index for Persistent stage 2/3 AKI
Stage_23_AKI_Index = seq(1, nrow(data_AKI), 1)[sapply(data_AKI$AKI_29Day, no_zero_in_first_2_and_2_3_in_day_3)]
...
## AKI (yes/no) for first 3 days: if the patient has AKI any day from enrollment to day 3 (AKI Daily > 0 in any day)
data_AKI$AKI_FIRST_3_DAYS = ifelse(( (data_AKI$AKIbase_stage==0 | is.na(data_AKI$AKIbase_stage==0)) & (data_AKI$AKI_Daily1==0 | is.na(data_AKI$AKI_Daily1)) & (data_AKI$AKI_Daily2==0 | is.na(data_AKI$AKI_Daily2)) ), 0, 1)
data_AKI$AKI_FIRST_3_DAYS_wo_NA = ifelse(( (data_AKI$AKIbase_stage==0) & (data_AKI$AKI_Daily1==0) & (data_AKI$AKI_Daily2==0) ), 0, 1)
...
## Persistent stage 2/3 AKI
data_AKI$Stage2_3_AKI = 0
data_AKI[Stage_23_AKI_Index, "Stage2_3_AKI"] = 1
...
data_AKI_sub = data_AKI %>%
  select(Stnum, AKIbase_stage, AKI, AKI_FIRST_3_DAYS, AKI_FIRST_3_DAYS_wo_NA, FIRST_AKI_DATE, FIRST_AKI_STAGE, 
         Persistent_Severe_AKI, Transient_AKI, Stage2_3_AKI, Persistent_Transient_Overlap, No_Persistent_Severe_AKI, 
         AKI_Recovery, AKI_Recovery_Total, AKD) 

names(data_AKI_sub)[names(data_AKI_sub) == "Stnum"] = "PatientID"


write.csv(data_AKI_sub, "/Users/chenxinlei/Library/Mobile Documents/com~apple~CloudDocs/Projects/Ang2/Data/AKI_Flag_Molinari_Data.csv", row.names = F)
